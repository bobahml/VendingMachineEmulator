...
namespace VendingMachine
{
    ...
    public partial class App
    {
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            serviceLocator.RegisterType<IVendingMachineChangeCalculator, GreedyVendingMachineChangeCalculator>();
            serviceLocator.RegisterType<ILocalizedMessageService, LocalizedMessageService>();
            serviceLocator.RegisterType<ISystemInitializer, SystemInitializer>();



          var dependencyResolver = this.GetDependencyResolver();
            var languageService = dependencyResolver.Resolve<ILanguageService>();
            var resourcesSource = new LanguageResourceSource("VendingMachine", "VendingMachine.Properties", "Resources");
